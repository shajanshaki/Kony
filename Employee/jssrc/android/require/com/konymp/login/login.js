define(function() {
    return function(controller) {
        ...
        var flxTouchId = new kony.ui.FlexContainer({
            ...
            "layoutType": kony.flex.FREE_FORM,
            "left": "0%",
            "onClick": controller.AS_FlexContainer_b83184b4130941619625d116530ff238,
            "skin": "CopyCopyCopyslFbox4",
            "width": "50%",
            "zIndex": 8
        }, {}, {});
        ...
        var flxFaceId = new kony.ui.FlexContainer({
            ...
            "layoutType": kony.flex.FREE_FORM,
            "left": "0dp",
            "onClick": controller.AS_FlexContainer_a14ae9a9309a43718587ebd67ff2015c,
            "skin": "slFbox",
            "width": "50%",
            "zIndex": 8
        }, {}, {});
        ...
        faceid.onEnrollSuccess = controller.AS_UWI_e28776fdfb374d5ea4736e8b109823cf;
        faceid.onInitSuccess = controller.AS_UWI_e6569280a4ba4be39ec0c33f5086d42a;
        faceid.onVerifySuccess = controller.AS_UWI_a6567082484d451585af611329e2f06b;
        faceid.onUnenrollSuccess = controller.AS_UWI_e4a2cf8feb854cb2b64d29acd4265991;
        faceid.onInitFailure = controller.AS_UWI_aaa94c682f204c5b92a0d43c994b364b;
        faceid.onVerifyFailure = controller.AS_UWI_ebc4c2c21e50475b9cb475700a9323e4;
        faceid.onEnrollFailure = controller.AS_UWI_i5f0dd98bfaa408db828ac904d09ce8e;
        faceid.onUnenrollFailure = controller.AS_UWI_edcae07dba2249409f165d8bca2bef8d;
        ...
        flxSIgnIn.add(flxTouchId, flxFaceId);
        flxLogin.add(flxBottomContainer, flxlogo, flxSocialLogin, flxCredentials, flxPopups, flxSIgnIn);
