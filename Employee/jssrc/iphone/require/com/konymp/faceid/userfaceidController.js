        ...
        initGettersSetters: function() {
            ...
            defineSetter(this, "enrollQualityThreshold", function(value) {
                try {
                    ...
                    if (value >= constants.ENROLL_QUALITY_THRESHOLD.MIN && value <= constants.ENROLL_QUALITY_THRESHOLD.MAX) this._enrollQualityThreshold = value;
                    else {
            ...
            defineSetter(this, "livenessMode", function(value) {
                try {
                    ...
                    if (value == "IMAGE") this._livenessMode = constants.LIVENESS_MODE.IMAGE;
                    else if (value == "LIVENESS_PASSIVE") this._livenessMode = constants.LIVENESS_MODE.LIVENESS_PASSIVE;
                } catch (e) {
                    konymp.logger.error(JSON.stringify(e), konymp.logger.EXCEPTION);
                }
            ...
            defineSetter(this, "livenessThreshold", function(value) {
                try {
                    ...
                    if (value >= constants.LIVENESS_THRESHOLD.MIN && value <= constants.LIVENESS_THRESHOLD.MAX) this._livenessThreshold = value;
                    else {
            ...
            defineSetter(this, "verifyQualityThreshold", function(value) {
                try {
                    ...
                    if (value >= constants.VERIFY_QUALITY_THRESHOLD.MIN && value <= constants.VERIFY_QUALITY_THRESHOLD.MAX) this._verifyQualityThreshold = value;
                    else {
            ...
            defineSetter(this, "matchingThreshold", function(value) {
                try {
                    ...
                    if (value >= constants.MATCHING_THRESHOLD.MIN && value <= constants.MATCHING_THRESHOLD.MAX) this._matchingThreshold = value;
                    else {
            ...
            defineSetter(this, "tokenConfigType", function(value) {
                try {
                    ...
                    if (value == "CLEAR_TEXT") this._tokenConfigType = constants.TOKEN_CONFIG_TYPE.CLEAR_TEXT;
                } catch (e) {
                    konymp.logger.error(JSON.stringify(e), konymp.logger.EXCEPTION);
                }
