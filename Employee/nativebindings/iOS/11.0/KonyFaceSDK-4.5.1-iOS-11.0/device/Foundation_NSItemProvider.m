...
{
	context[@"NSItemProviderRepresentationVisibilityAll"] = @0;
	context[@"NSItemProviderRepresentationVisibilityTeam"] = @1;
	context[@"NSItemProviderRepresentationVisibilityOwnProcess"] = @3;

	context[@"NSItemProviderFileOptionOpenInPlace"] = @1;
