...
-(NSOperatingSystemVersion) toNSOperatingSystemVersion {
	return (NSOperatingSystemVersion) {
		(NSInteger) [self[@"majorVersion"] toInt32],
		(NSInteger) [self[@"minorVersion"] toInt32],
		(NSInteger) [self[@"patchVersion"] toInt32],
	};
}
@end
...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"NSProcessInfoThermalStateNominal"] = @0;
	context[@"NSProcessInfoThermalStateFair"] = @1;
	context[@"NSProcessInfoThermalStateSerious"] = @2;
	context[@"NSProcessInfoThermalStateCritical"] = @3;
