...
{
	context[@"NSDateIntervalFormatterNoStyle"] = @0UL;
	context[@"NSDateIntervalFormatterShortStyle"] = @1UL;
	context[@"NSDateIntervalFormatterMediumStyle"] = @2UL;
	context[@"NSDateIntervalFormatterLongStyle"] = @3UL;
	context[@"NSDateIntervalFormatterFullStyle"] = @4UL;
