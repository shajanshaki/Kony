...
{
	context[@"NSUbiquitousKeyValueStoreServerChange"] = @0L;
	context[@"NSUbiquitousKeyValueStoreInitialSyncChange"] = @1L;
	context[@"NSUbiquitousKeyValueStoreQuotaViolationChange"] = @2L;
	context[@"NSUbiquitousKeyValueStoreAccountChange"] = @3L;
