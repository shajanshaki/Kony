...
{
	context[@"NSFileCoordinatorReadingWithoutChanges"] = @1UL;
	context[@"NSFileCoordinatorReadingResolvesSymbolicLink"] = @2UL;
	context[@"NSFileCoordinatorReadingImmediatelyAvailableMetadataOnly"] = @4UL;
	context[@"NSFileCoordinatorReadingForUploading"] = @8UL;

	context[@"NSFileCoordinatorWritingForDeleting"] = @1UL;
	context[@"NSFileCoordinatorWritingForMoving"] = @2UL;
	context[@"NSFileCoordinatorWritingForMerging"] = @4UL;
	context[@"NSFileCoordinatorWritingForReplacing"] = @8UL;
	context[@"NSFileCoordinatorWritingContentIndependentMetadataOnly"] = @16UL;
