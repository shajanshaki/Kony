...
{
	context[@"NSPostWhenIdle"] = @1UL;
	context[@"NSPostASAP"] = @2UL;
	context[@"NSPostNow"] = @3UL;

	context[@"NSNotificationNoCoalescing"] = @0UL;
	context[@"NSNotificationCoalescingOnName"] = @1UL;
	context[@"NSNotificationCoalescingOnSender"] = @2UL;
