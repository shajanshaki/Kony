...
{
	context[@"NSFileWrapperReadingImmediate"] = @1UL;
	context[@"NSFileWrapperReadingWithoutMapping"] = @2UL;

	context[@"NSFileWrapperWritingAtomic"] = @1UL;
	context[@"NSFileWrapperWritingWithNameUpdating"] = @2UL;
